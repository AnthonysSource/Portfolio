...
namespace CKE {
	...
	public:
		...
		Map<ComponentTypeID, ArchetypeComponentRecord> m_ArchetypeComponents{}; // Archetype Components of this archetype
	...
	public:
		...
		// Returns a ptr to the component data of the given position in the archetype table
