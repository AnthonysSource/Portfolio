...
namespace CKE {
	...
	void RenderingSystem::Shutdown() {
		...
		CKE::Delete(m_DepthPass);
		CKE::Delete(m_GBufferPass);
		CKE::Delete(m_LightingPass);
		CKE::Delete(m_SSAOPass);
		CKE::Delete(m_SSAOBlurPass);
		CKE::Delete(m_TonemappingPass);
		CKE::Delete(m_FXAAPass);
		CKE::Delete(m_SkyBoxPass);
		CKE::Delete(m_BloomModule);
		CKE::Delete(m_PresentPass);
	}
